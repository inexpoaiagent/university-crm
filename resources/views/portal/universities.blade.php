...
<div class="card">
    ...
    <p class="footer-note">You can request application review for any university. Admin will review and create your official application.</p>
    <div class="grid-4">
        @foreach($universities as $u)
            <div class="card">
                <strong>{{ $u->name }}</strong>
                <p class="footer-note">{{ $u->country }} | {{ $u->currency }} | Match {{ $u->match_score }}%</p>
