...
Route::middleware(['auth.crm', 'tenant'])->group(function (): void {
    ...
    Route::post('/students/{id}/documents/{docId}/verify', [StudentController::class, 'verifyDocument'])->middleware('permission:students.update');
    Route::delete('/students/{id}/documents/{docId}', [StudentController::class, 'deleteDocument'])->middleware('permission:students.update');
